...
connection = pymysql.connect(
    host="localhost", user="elviso", password="elvisoelfisi", db="cv"
)
...
def run():
    ...
    link = '<b>Built with 🤍 by Brian Melly.</b>'
            ...
            if resume_data:
                ...
                for i in resume_data["skills"]:
                    ...
                    #### For Not Any Recommendations
                        ...
                        st.markdown(
                            """<h5 style='text-align: left; color: #092851;'>Maybe Available in Future Updates</h5>""",
                            unsafe_allow_html=True,
                        )
                        # course recommendation
